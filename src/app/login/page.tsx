      ...
      <div className="max-w-md mx-auto px-6 py-16">
        <div className="bg-white rounded-3xl shadow-2xl p-10 border border-zinc-100">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <button
              type="submit"
              className="w-full bg-orange-500 hover:bg-orange-600 text-white py-3 rounded-2xl font-semibold shadow-lg transition cursor-pointer"
            >
              Entrar
            </button>
          </form>
          ...
          <p className="text-center text-zinc-500 text-sm mt-6">
            Não tem uma conta?{" "}
            <Link href="/cadastro" className="text-orange-500 font-semibold">
              Cadastre-se
            </Link>
          </p>
